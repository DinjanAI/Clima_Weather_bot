...
def send_welcome(message):
    # This message will be print when /start command is given
    bot.send_message(message.chat.id, 'Welcome to WeatherBot! Get instant weather updates for your area. Just send your location or ask for the forecast. Stay prepared and stay safe! ☀️🌧️')
